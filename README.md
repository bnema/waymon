...
wget https://github.com/bnema/waymon/releases/download/v0.1.4-dev/waymon_0.1.4-dev_linux_amd64.pkg.tar.zst

# Install with pacman
sudo pacman -U waymon_0.1.4-dev_linux_amd64.pkg.tar.zst
```
...
```bash
# Download the package
wget https://github.com/bnema/waymon/releases/download/v0.1.4-dev/waymon_0.1.4-dev_linux_amd64.deb

# Install with dpkg
sudo dpkg -i waymon_0.1.4-dev_linux_amd64.deb
```
...
```bash
# Download the package
wget https://github.com/bnema/waymon/releases/download/v0.1.4-dev/waymon_0.1.4-dev_linux_amd64.rpm

# Install with rpm
sudo rpm -i waymon_0.1.4-dev_linux_amd64.rpm
```
...
wget https://github.com/bnema/waymon/releases/download/v0.1.4-dev/waymon_Linux_x86_64.tar.gz
