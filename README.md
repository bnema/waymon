...
wget https://github.com/bnema/waymon/releases/download/v0.3.2/waymon_0.3.2_linux_amd64.pkg.tar.zst

# Install with pacman
sudo pacman -U waymon_0.3.2_linux_amd64.pkg.tar.zst
```
...
```bash
# Download the package
wget https://github.com/bnema/waymon/releases/download/v0.3.2/waymon_0.3.2_linux_amd64.deb

# Install with dpkg
sudo dpkg -i waymon_0.3.2_linux_amd64.deb
```
...
```bash
# Download the package
wget https://github.com/bnema/waymon/releases/download/v0.3.2/waymon_0.3.2_linux_amd64.rpm

# Install with rpm
sudo rpm -i waymon_0.3.2_linux_amd64.rpm
```
...
wget https://github.com/bnema/waymon/releases/download/v0.3.2/waymon_Linux_x86_64.tar.gz
